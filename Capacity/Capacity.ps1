...
# EMAIL PROPERTIES 
 # Set the recipients of the report. 
  #$users = "john.oliver@frontline-consultancy.co.uk" 
 
# REPORT PROPERTIES 
 # Path to the report 
  $reportPath = "C:\Powershell\Capacity\"; 
 
 # Report name 
  $reportName = "DiskCapacity.html"; 
...
$computers = Get-Content "C:\Powershell\Capacity\Server List.txt"; 
...
# Cleanup old files.. # REM'd out last 4 lines below
# $Daysback = "-7" 
...
Write-Host -ForegroundColor Blue "$computer $deviceID percentage free space = $percentFree"; 
    $i++   
  } 
 } 
} 
